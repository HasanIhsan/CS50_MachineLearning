...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    # Helper: actual gene count for a person
    ...
    # Helper: probability parent passes gene copy
    def pass_prob(parent):
        count = gene_count(parent)
        if count == 2:
    ...
    for person, info in people.items():
        ...
        if mother is None and father is None:
            ...
            mom_p = pass_prob(mother)
            dad_p = pass_prob(father)
            if genes == 2:
                gene_prob = mom_p * dad_p
            elif genes == 1:
                gene_prob = mom_p * (1 - dad_p) + (1 - mom_p) * dad_p
            else:
                gene_prob = (1 - mom_p) * (1 - dad_p)
        # Trait probability
